...
export default function Public() {
  ...
  const tagline = useMemo(() => choice([
    'As asas da noite protegem nosso clã.',
    'Sangue e ouro, honra e glória.',
    'Corvos unidos, sombras vencidas.',
    'Chamado das trevas, resposta dos corvos.',
    'A lâmina do destino corta ao nosso favor.'
  ]), [])
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-3 p-3 rounded border border-yellow-700 bg-yellow-900/30 text-sm">
        Recomenda-se exportar seus dados periodicamente (Admin → Exportar JSON).
      </div>
